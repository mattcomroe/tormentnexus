...
## ChangeType
**Physical table:** `OSUSR_xhk_ChangeType`  
...
**Physical table:** `OSUSR_xhk_FBAuthenticationType`  
...
**Physical table:** `OSUSR_xhk_FBGlobalQueryCallbackType`  
...
## WhereClauseDataType
**Physical table:** `OSUSR_xhk_WhereClauseDataType`  
...
## WhereClauseOperator
**Physical table:** `OSUSR_xhk_WhereClauseOperator`  
