...
## ChangeType
**Physical table:** `OSUSR_2uj_ChangeType`  
...
**Physical table:** `OSUSR_2uj_FBAuthenticationType1`  
...
**Physical table:** `OSUSR_2uj_FBGlobalQueryCallbackType`  
...
## WhereClauseDataType
**Physical table:** `OSUSR_2uj_WhereClauseDataType`  
...
## WhereClauseOperator
**Physical table:** `OSUSR_2uj_WhereClauseOperator`  
